...
@RestController
public class GaugeDemoController {
	
	private static final Logger logger = LoggerFactory.getLogger(GaugeDemoController.class);
    /**指标注册
     * name设置指标名
     * labelNames设置各项指标名称
     * help设置指标描述
    ...
    public void changeGauge() {
        ...
        logger.info("changeGauge:{}", gaugeDemo.collect());
    }
}